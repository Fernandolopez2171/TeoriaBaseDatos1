 ...
 * @author AxelM
 */
public class MantenimientoTransport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TIPOBOX1 = new javax.swing.JComboBox<>();
        ...
        jLabel4.setText("DIRECCION ACTUAL:");
        ...
        TIPOBOX1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CAMION ", "BARCO" }));
        TIPOBOX1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TIPOBOX1ActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(TIPOBOX1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(IDTEXT, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(89, 89, 89)
                                .addComponent(jLabel4)
                                .addGap(35, 35, 35)
                                .addComponent(DIRETEXT, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       //CREAR
        ID = IDTEXT.getText();
        Tipo = TIPOBOX1.getSelectedItem().toString();
        Direccion = DIRETEXT.getText();
        ...
        if(ID.equals("")||Tipo.equals("")||Estado.equals("")||Direccion.equals("")){
             JOptionPane.showMessageDialog(null, "Falta ingresar un dato");
        }else{
          if(validarTipo.equals("Transportista")){
            conexion consulta = new conexion();
            String sql;
            sql="INSERT INTO \"Transporte\"(\"Id_Transporte\",\"Tipos\",\"Estado\",\"Direccion\",\"IDUser\")VALUES('"+ID+"','"+Tipo+"','NO ACCIDENTADO','"+Direccion+"','"+User+"')";
            ...
            Actualizar();
              ...
              JOptionPane.showMessageDialog(null, "Usuario Mencionado no es un transportita.");
          }
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Direccion = DIRETEXT.getText();
         ...
         if(ID.equals("")||Tipo.equals("")||Direccion.equals("")){
             JOptionPane.showMessageDialog(null, "Falta ingresar un dato");
        }else{
            conexion consulta = new conexion();
            String sql;
            sql = "Update \"Transporte\" set \"Tipos\"='"+Tipo+"',\"Direccion\"='"+Direccion+"' WHERE \"Id_Transporte\"='"+ID+"'";
            consulta.ejecutarSQL(sql);
            //limpia los textbox
            lim();
            //limpia el Jtable
    ...
    private void TIPOBOX1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TIPOBOX1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TIPOBOX1ActionPerformed
    ...
    public void lista(String id,String tipo, String estado, String dir,String validarUser) {
     ...
     public ResultSet consultarDB() throws Exception{
        ...
        public ResultSet consultarTransporte(String id) throws Exception{
        conexion sql= new conexion();
        Connection data = sql.conectar();
        ResultSet resultado;
        Statement sentencia = null;
        try{
           String Consulta ="SELECT * FROM \"Transporte\" WHERE \"Id_Transporte\"='"+id+"'";  
           sentencia = data.createStatement();
           resultado = sentencia.executeQuery(Consulta);
           return resultado;
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantenimientoTransport().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> TIPOBOX1;
